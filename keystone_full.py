...
command = 'ansible-playbook -e "host_key_checking=False ansible_python_interpreter=/usr/bin/python3 ansible_ssh_common_args=\'-o StrictHostKeyChecking=no\'"  keystone/keystone.yaml -i "{0}," -u {1} --ask-become-pass'
